...
export default function About() {
  ...
  return (
    <section 
      ...
      aria-label="About Shriya Sandesh Kulkarni - Full Stack Developer"
      itemScope
    ...
    >
      ...
      <meta itemProp="url" content="https://shriyakulkarni.dev" />
      <meta itemProp="email" content={PERSONAL_INFO.email} />
      <meta itemProp="telephone" content={PERSONAL_INFO.phone} />
      <meta itemProp="image" content={`https://shriyakulkarni.dev${PERSONAL_INFO.image}`} />
      ...
      <Container>
        ...
        {/* Hidden SEO Content */}
          <div className="sr-only">
            <h2>About Shriya Sandesh Kulkarni - Full Stack Developer</h2>
            <p>
