...
const socialLinks = [
  { name: 'GitHub', url: 'https://github.com/shriyakulkarni', icon: Github, color: '#FFFFFF' },
  { name: 'LinkedIn', url: 'https://linkedin.com/in/shriyakulkarni', icon: Linkedin, color: '#0A66C2' },
  { name: 'Email', url: 'mailto:shriya25.main@gmail.com', icon: Mail, color: '#30D158' },
];
