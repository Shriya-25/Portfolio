...
export default function Navbar() {
  ...
  const activeSection = useScrollSpy(['hero', 'about', 'skills', 'work', 'resume', 'contact']);
        ...
        <div className="relative max-w-7xl mx-auto flex items-center">
          ...
          >
            <div style={{ mixBlendMode: 'screen' }}>
              <Image 
                src="/icons/logo.png" 
                alt="Shriya Sandesh Kulkarni - Full Stack Developer Logo" 
                width={80}
                height={80}
        ...
        <div className="backdrop-blur-sm border border-white/[0.05] rounded-full px-4 py-2 shadow-lg flex justify-between items-center">
          ...
          >
            <div style={{ mixBlendMode: 'screen' }}>
              <Image 
                src="/icons/logo.png" 
                alt="Shriya Sandesh Kulkarni Logo" 
                width={40}
                height={40}
                priority
              />
